...
from .models import Influencerdb, Postdb
...
class InfluencerView(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super(InfluencerView, self).get_context_data(**kwargs)
    ...
    def get_queryset(self):
        post_data = Postdb.objects.values()
        influencer_data = Influencerdb.objects.values()
